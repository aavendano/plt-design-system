...
Every pattern that contains a daisyUI primitive keeps the daisyUI `d-*` class and adds PLT composition/theme classes on top.
...
<article class="d-card bg-base-100 theme-bordered theme-elevated plt-media-card plt-product-card">
  ...
  <div class="d-card-body plt-media-card__body">
    ...
    <div class="plt-media-card__actions">
      ...
      <a class="d-btn d-btn-secondary theme-bordered theme-elevated theme-label-bold" href="#">View</a>
    </div>
  </div>
</article>
```
...
<a class="d-card bg-base-100 theme-bordered theme-elevated plt-media-card plt-collection-card" href="#">
  ...
  <div class="d-card-body plt-media-card__body">
    <h2 class="plt-headline-sm plt-media-card__title">Collection title</h2>
    <p class="plt-meta">Short description.</p>
  </div>
</a>
```
...
<article class="d-card bg-base-100 theme-bordered theme-elevated plt-media-card plt-editorial-card">
  ...
  <div class="d-card-body plt-media-card__body">
    ...
    <div class="plt-media-card__actions"><a class="d-btn d-btn-ghost theme-label-bold" href="#">Read more</a></div>
  </div>
</article>
```
